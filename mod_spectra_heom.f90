...
subroutine setup_parameters
  ...
  !JJ=1.0!*wave_to_J
  !gamma=1.d0/100.d-15*au2s
  !eta=2*120.d0/hbar*wave_to_J/au2J
  eta=2*94.4d0/hbar*wave_to_J/au2J
...
!stop
  ...
  dip_moment_pos(3,1)=1.d0
  dip_moment_pos(4,2)=1.d0
  ...
  Hamil_e=0.d0
  Hamil_e(2,2)=-250.d0;Hamil_e(2,3)=100.d0
  Hamil_e(3,2)=100.d0;Hamil_e(3,3)=250.d0
  Hamil_e(4,4)=0.d0
  ...
  integer nvec(nquant,0:KK)!,nvec_plus(nquant,KK),nvec_neg(nquant,KK)
    ...
    if(zero(n)==0) then !! matrix at n is not filtered out
      ...
      do m=2,nquant
        ...
        tmp=tmp-(eta*kb*temperature/gamma-eta/2.d0*cotan(gamma/(2*kb*temperature)))*commute(mat_tmp,commute(mat_tmp,rho(:,:,n)))
